...
const ContentComponent = ({ headerContent, titlePage, data }) => {
  return (
    <div className="w-full min-h-screen bg-white flex flex-col items-center py-8">
      <h2 className="text-[95px] text-gray-400 font-bold mb-2" style={{ fontFamily: 'MyFont' }}>
        {headerContent}
      </h2>
      <h3 className="text-3xl font-bold tracking-widest mb-12">{titlePage}</h3>
